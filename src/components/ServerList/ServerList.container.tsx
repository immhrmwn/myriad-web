          ...
          <Grid item md={4} xs={6}>
            <Card variant="outlined" className={style.card}>
              <ListItem>
                ...
                <ListItemText
                  primary={<Typography className={style.title}>Total instances</Typography>}
                  secondary={<Typography className={style.subtitle}>100,000</Typography>}
                />
              </ListItem>
            </Card>
          </Grid>
          <Grid item md={4} xs={6}>
            <Card variant="outlined" className={style.card}>
              <ListItem>
                ...
                <ListItemText
                  primary={<Typography className={style.title}>Total users</Typography>}
                  secondary={<Typography className={style.subtitle}>800,000</Typography>}
                />
              </ListItem>
            </Card>
          </Grid>
          <Grid item md={4} xs={6}>
            <Card variant="outlined" className={style.card}>
              <ListItem>
                ...
                <ListItemText
                  primary={<Typography className={style.title}>Total posts</Typography>}
                  secondary={<Typography className={style.subtitle}>1,500,000</Typography>}
                />
              </ListItem>
            </Card>
          </Grid>
